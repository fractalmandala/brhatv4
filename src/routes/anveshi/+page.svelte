...
<div class="full-page formatting">
	<div class="no-side">
		...
		<div class="gp3 x2">
			{#await allChapters()}
				...
				<div class="cols3">
					...
					<h6 class="m-top-24 m-bot-zero"><a href={item.link}>{item.name}</a></h6>
					<small class="m-top-8 grey">{item.content.slice(0,250)}<a class="anv wbold" href={item.link}>...Read More</a></small>
		...
		<div class="the-title" id="traveldiaries">
		...
		<div class="the-title" id="aboutanveshi">
...
@media screen and (min-width: 900px) {
	...
	.x1 { height: 70vh;}
	.x3 { padding-bottom: 32px;}
	.x4 img { object-fit: cover; height: 200px;}
	.x5 { margin-top: 24px;}
	.x5 .cols4 { height: 200px;}
