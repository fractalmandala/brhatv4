...
<div class="pad-a rrr">
	<GrandContainer>
		...
		<div slot="desknav" class="deskdesk">
			<ShareSocial></ShareSocial>
				<h6 class="pointer" on:click={toggle1} on:keydown={toggle1}>Karnataka Chapter</h6>
	...
	<div class="x-x-2">
		...
		<div class="boxr gap24 mtop24">
			<button class="mainbutton karn" on:click={toggle2} on:keydown={toggle2}>Itinerary</button>
			<button class="mainbutton karn" on:click={toggle3} on:keydown={toggle3}>Temples</button>
		</div>
		{/if}
		...
		>
			<div id="element-2" class="boxc">
				...
				<small>loading...</small>
				{:then data}
				<small class="cut karn">Click on Day to Expand</small>
		...
		<div class="boxr gap24 mtop24">
			<button class="mainbutton karn" on:click={toggle1} on:keydown={toggle1}>Overview</button>
			<button class="mainbutton karn" on:click={toggle3} on:keydown={toggle3}>Temples</button>
		</div>
		{/if}
