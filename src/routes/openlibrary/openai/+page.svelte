<script>
	...
	import Home from '$lib/components/globals/HomeComp.svelte';
	import RecommendationCard from '$lib/components/globals/RecommendationCard.svelte';
	import { onMount } from 'svelte';
	import LoadingCard from '$lib/components/globals/LoadingCard.svelte';
	let loading = false;
	let error = '';
	let endStream = false;
