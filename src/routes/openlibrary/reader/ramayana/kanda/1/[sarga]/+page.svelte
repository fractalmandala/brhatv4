...
<div class="boxr bread-crumb">
	<cite><a href="/openlibrary/reader/ramayana/kanda/1">Kāṇḍa 1</a> <span> > </span><span class="rama">Sarga {data.sarga}</span></cite>
</div>
<div class="sargacontainer">
<h5>Verses of Kāṇḍa 1, Sarga {data.sarga}</h5>
