...
<div class="boxr bread-crumb">
	<cite><a href="/openlibrary/reader/ramayana/kanda/6">Kāṇḍa 6</a> <span> > </span><span class="rama">Sarga {data.sarga}</span></cite>
</div>
<div class="sargacontainer">
<h5>Verses of Kāṇḍa 6, Sarga {data.sarga}</h5>
<h6 on:click={togglePadas} on:keydown={togglePadas}>Toggle All Verses</h6>
	<div class="sargaverses">
		...
		<div class="versepadabox">
			<p><a href="/openlibrary/reader/ramayana/kanda/6/{data.sarga}/{item.verse}">{item.verse}</a></p>
		</div>	
		{/each}
	</div>
	{#if showPadas}
