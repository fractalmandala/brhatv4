...
<div class="boxr bread-crumb">
	<cite><a href="/openlibrary/reader/ramayana/kanda/5">Kāṇḍa 5</a> <span> > </span><a href="/openlibrary/reader/ramayana/kanda/5/{data.sarga}">Sarga {data.sarga} </a><span> > </span><span class="rama">Verse {data.verse}</span></cite>
</div>
<div class="sargacontainer">
<h5>Pādas of Kāṇḍa 5, Sarga {data.sarga}, Verse {data.verse}</h5>
