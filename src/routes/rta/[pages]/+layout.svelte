<script lang="ts">
import '$lib/styles/rtastyling.sass'
	...
	<div class="sidebar-area" class:fullHeight={fullHeight}>
		...
		<div class="sidebarlinks">
			<div class="linkssection" on:click={toggleMobileLinks} on:keydown={toggleMobileLinks}>
				...
				<p><a href="/rta/prologue">Prelude - Culture and Design</a></p>
				<p><a href="/rta/intro">Introduction to Ṛta in Design</a></p>
				<p><a href="/rta/dharmaisdesign">Dharma is Design</a></p>
				<p><a href="/rta/designsystem/framework">Framework</a></p>
				<p><a href="/rta/designsystem/principles">Principles</a></p>
				<p><a href="/rta/designsystem/phases">Phases</a></p>
				<p><a href="/rta/designsystem/resources">Tools and Resources</a></p>
				<p><a href="/rta/designatbrhat">Design @ Bṛhat</a></p>
			</div>
		</div>
	</div>
	<div class="area-main">
