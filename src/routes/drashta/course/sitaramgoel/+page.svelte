...
<div class="pad-a rrr">
	...
	<GrandContainer>
		...
		<p slot="sectionname"><span class="drash">Sita Ram </span>Goel</p>
		<div slot="mobilenav" class="mobmob">
			...
			<h6 in:fly={{ duration: 300, delay: 200, x: 0, y: -160}} out:fly={{ duration: 200, delay: 0, x: 0, y: -160}}>Sita Ram Goel</h6>
		...
		<div slot="desknav" class="deskdesk">
			...
			<h6 class="pointer">Sita Ram Goel</h6>
	...
	<div class="x-x-2">
		...
		{#if panel1}
			<div class="traybox wrap x1">
				<div class="ww2">
					<img src="/images/drashta/sitaramgoel.webp" alt="sita ram goel"/>
				</div>
