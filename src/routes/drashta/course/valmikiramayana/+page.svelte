...
<div class="wid-side">
	<GrandContainer>
		<div slot="mobilenav" class="mobmob">
				...
				<h6 in:fly={{ duration: 300, delay: 200, x: 0, y: -160}} out:fly={{ duration: 200, delay: 0, x: 0, y: -160}}>Śrīmad Vālmiki Rāmāyana Pārāyana</h6>
		...
		<div slot="desknav" class="deskdesk">
			...
			<div class="tabhead">
				<h6>Śrīmad Vālmiki Rāmāyana Pārāyana</h6>
			</div>
