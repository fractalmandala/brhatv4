...
<div class="pad-a rrr">
	...
	<GrandContainer>
		...
		<p slot="sectionname"><span class="drash">Shri Ram </span>Swarup</p>
		...
		<div slot="desknav" class="deskdesk">
			...
			<h6 class="pointer">Shri Ram Swarup</h6>
	...
	<div class="x-x-2">
		...
		{#if panel1}
			<div class="traybox wrap x1">
				<div class="ww2">
					<img src="/images/drashta/ramswarup.webp" alt="shri ram swarup"/>
				</div>
				<div class="ww2 the-title">
					<h1>Shri Ram Swarup</h1>
				</div>
			</div>
