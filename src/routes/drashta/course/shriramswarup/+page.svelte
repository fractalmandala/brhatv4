...
<div class="imagecontainer col-y-top col-x-left" style="background-image: url({item.image})">
	<div class="imagecontainer-screen">
		<h1>Introduction to Shri Ram Swarup</h1>
	</div>
</div>
<div class="blog-pad">
...
<div class="base-row" id="contentrow">
	{#each data as item}
	<div class="base-col" id="contentcol">
		<h5>{item.name}</h5>
...
.imagecontainer h1 { color: white; text-shadow: 4px 4px 8px rgba(0,0,0,0.6); margin-left: 3.2rem;}
