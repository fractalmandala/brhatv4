...
<div class="pad-a rrr">
	...
	<GrandContainer>
		...
		<p slot="sectionname"><span class="drash">Hindu </span>Iconography</p>
		...
		<div slot="desknav" class="deskdesk">
			...
			<h6 class="pointer">Hindu Iconography</h6>
	...
	<div class="x-x-2">
		...
		{#if panel1}
			<div class="traybox wrap x1">
				<div class="ww2">
					<img src="/images/herocovers/hinduiconography.webp" alt="hicon"/>
				</div>
