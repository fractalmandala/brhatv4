...
<div class="full-page formatting">
	<div class="pad-a">
		...
		<div class="boxc x6 bdt for-links">
			<h2><a href="/about/docs/svatahsiddha">svataḥsiddha</a></h2>
			<h2><a href="/about/docs/anatomy">civilizational moment</a></h2>
		...
		<div class="the-title y-full" id="advisors">
			<h2>
			Advisors
			</h2>
			<div class="traybox x7">
				{#await advisors()}
				<small>...</small>
				{:then data}
				{#each data as item}
		...
		<div class="the-title y-full" id="partners">
			<h2>
				Partners
			</h2>
