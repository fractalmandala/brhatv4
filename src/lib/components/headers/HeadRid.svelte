     ...
     <div class="logotype">
      	<a href="/rta">
					<div class="logo-svg-box">
						<img src="/images/headerlogos/logo-rid.png" alt="rta in design" />
					</div>
				</a>
     </div>
  </div>
  <div class="navbar">
			<div class="menuitems opener" on:mouseenter={showAreas} on:mouseleave={hideAreas}><p>Principles</p>
				{#if isAreas}
				<div class="second-row">
					<div class="rowitems"><a href="/rta/principles/intent">Intent</a></div>
					<div class="rowitems"><a href="/rta/principles/agency">Agency</a></div>
					<div class="rowitems"><a href="/rta/principles/grounding">Grounding</a></div>
					<div class="rowitems"><a href="/rta/principles/consonance">Consonance</a></div>
				</div>
				{/if}
			</div>
			<div class="menuitems opener" on:mouseenter={showSyn} on:mouseleave={hideSyn}><p>Phases</p>
				{#if isSyn}
				<div class="second-row">
					<div class="rowitems"><a href="/rta/phases/svatahsiddha">Svataḥsiddha</a></div>
					<div class="rowitems"><a href="/rta/phases/purohita">Purohita</a></div>
					<div class="rowitems"><a href="/rta/phases/samkartra">Saṃskārtṛ</a></div>
				</div>
				{/if}
			</div>
			<div class="menuitems"><a href="/rta/docs/creativity">On Creativity</a></div>
	...
	<div class="fullscreener"
		...
		<div class="fullscreenpage">
			<div class="fullscreencol" id="columnleft">
				<div class="fslinks drashtafs"><p>Principles</p>
					<div class="nowitems"><a href="/rta/principles/intent">Intent</a></div>
					<div class="nowitems"><a href="/rta/principles/agency">Agency</a></div>
					<div class="nowitems"><a href="/rta/principles/grounding">Grounding</a></div>
					<div class="nowitems"><a href="/rta/principles/consonance">Consonance</a></div>
				</div>
				<div class="fslinks drashtafs"><p>Phases</p>
					<div class="nowitems"><a href="/rta/phases/svatahsiddha">Svataḥsiddha</a></div>
					<div class="nowitems"><a href="/rta/phases/purohita">Purohita</a></div>
					<div class="nowitems"><a href="/rta/phases/samkartra">Saṃskārtṛ</a></div>
				</div>
				<div class="fslinks drashtafs"><a href="/rta/docs/creativity">On Creativity</a>
				</div>
			</div>
