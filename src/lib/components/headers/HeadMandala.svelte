     ...
     <div class="logotype">
      	<a href="/mandala">
					<div class="logo-svg-box">
						<img src="/images/headerlogos/logo-fm.png" alt="fractal mandala" />
					</div>
				</a>
     </div>
  </div>
  <div class="navbar">
			<div class="menuitems opener" on:mouseenter={showAreas} on:mouseleave={hideAreas}><p>Essays</p>
				{#if isAreas}
				<div class="second-row">
					<div class="rowitems"><a href="/mandala/essays/fm1">Fractal Maṇḍala 1</a></div>
					<div class="rowitems"><a href="/mandala/essays/fm2">Ratha as a Bīja</a></div>
					<div class="rowitems"><a href="/mandala/essays/fm3">History vs. Itihāsa</a></div>
					<div class="rowitems"><a href="/mandala/essays/fm4">Civilizational Consciousness</a></div>
				</div>
				{/if}
			</div>
			<div class="menuitems opener" on:mouseenter={showSyn} on:mouseleave={hideSyn}><p>Synaptic Reconnection</p>
				{#if isSyn}
				<div class="second-row">
					<div class="rowitems"><a href="/mandala/synaptic/schema">Schema</a></div>
					<div class="rowitems"><a href="/mandala/synaptic/artava">Ārtava</a></div>
					<div class="rowitems"><a href="/mandala/synaptic/atmya">Ātmya</a></div>
				</div>
				{/if}
			</div>
			<div class="menuitems"><a href="/mandala/aphorisms">Caturasūtra</a></div>
			<div class="menuitems opener" on:mouseenter={showOther} on:mouseleave={hideOther}><p>Other</p>
				...
				<div class="second-row">
					...
					<div class="rowitems"><a href="/about">About</a></div>
				</div>
				{/if}
			</div>
   	</div>
	...
	<div class="fullscreener"
		...
		<div class="fullscreenpage">
			<div class="fullscreencol" id="columnleft">
				<div class="fslinks drashtafs"><p>Essays</p>
					<div class="nowitems"><a href="/mandala/essays/fm1">Fractal Maṇḍala 1</a></div>
					<div class="nowitems"><a href="/mandala/essays/fm2">Ratha as a Bīja</a></div>
					<div class="nowitems"><a href="/mandala/essays/fm3">History vs. Itihāsa</a></div>
					<div class="nowitems"><a href="/mandala/essays/fm4">Civilizational Consciousness</a></div>
				</div>
				<div class="fslinks drashtafs"><p>Synaptic Reconnection</p>
					<div class="nowitems"><a href="/mandala/synaptic/schema">Schema</a></div>
					<div class="nowitems"><a href="/mandala/synaptic/artava">Ārtava</a></div>
					<div class="nowitems"><a href="/mandala/synaptic/atmya">Ātmya</a></div>
				</div>
				<div class="fslinks drashtafs"><a href="/mandala/aphorisms">Caturasūtra</a>
				</div>
			</div>
...
.logo-svg-box { 
	transition: all 0.16s var(--cube2);
...
.logo-svg-box:hover { transform: scale(0.9);}
...
.drashtafs p { color: white; font-weight: 500;}
...
.logotype { display: flex; flex-direction: row;}
...
@media screen and (min-width: 900px) {
	.logotype { height: 48px; align-items: flex-end; width: 100%;justify-content: flex-start;  }
	.logo-svg-box img { object-fit: contain; height: 48px; margin-top: 4px; margin-bottom: -2px;}
	.mobilemenu {
		display: none;
	}
	.navbar {
...
@media screen and (max-width: 899px) and (min-width: 768px) {
	.logotype { height: 48px; align-items: center; width: 100%; }
	.logo-svg-box img { object-fit: contain; height: 48px; margin-top: 0; }
	.logoarea { width: 35%; }
 	.headerbox { 
		padding: 0 16px; 
		height: 72px; 
...
@media screen and (max-width: 767px) and (min-width: 576px) {
	.logotype { height: 48px; align-items: center; width: 100%; }
	.logo-svg-box img { object-fit: contain; height: 48px; margin-top: -4px; }
	.logoarea { width: 50%; }
