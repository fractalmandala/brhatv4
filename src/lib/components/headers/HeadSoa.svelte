     ...
     <div class="logotype">
      	<a href="/aryavarta">
					<div class="logo-svg-box">
						<img src="/images/headerlogos/logo-soa.png" alt="scrolls of aryavarta" />
					</div>
				</a>
     </div>
  </div>
  <div class="navbar">
			<div class="menuitems opener" on:mouseenter={showAreas} on:mouseleave={hideAreas}><p>Chapters</p>
				{#if isAreas}
				<div class="second-row">
					<div class="rowitems"><a href="/aryavarta/chapter/01">Kaśyapa's Lament</a></div>
					<div class="rowitems"><a href="/aryavarta/chapter/02">Sūta and Sudā</a></div>
				</div>
				{/if}
			</div>
			<div class="menuitems opener" on:mouseenter={showSyn} on:mouseleave={hideSyn}><p>Veda</p>
				{#if isSyn}
				<div class="second-row">
					<div class="rowitems"><a href="/aryavarta/chapter/nasadiya">Nāsadīya</a></div>
					<div class="rowitems"><a href="/aryavarta/chapter/mysticfire">Mystic Fire</a></div>
				</div>
				{/if}
			</div>
			<div class="menuitems"><a href="/aryavarta/gallery">Gallery</a></div>
	...
	<div class="fullscreener"
		...
		<div class="fullscreenpage">
			<div class="fullscreencol" id="columnleft">
				<div class="fslinks drashtafs"><p>Chapters</p>
					<div class="nowitems"><a href="/aryavarta/chapter/01">Kaśyapa's Lament</a></div>
					<div class="nowitems"><a href="/aryavarta/chapter/02">Sūta and Sudā</a></div>
				</div>
				<div class="fslinks drashtafs"><p>Veda</p>
					<div class="nowitems"><a href="/aryavarta/chapter/nasadiya">Nāsadīya</a></div>
					<div class="nowitems"><a href="/aryavarta/chapter/mysticfire">Mystic Fire</a></div>
				</div>
